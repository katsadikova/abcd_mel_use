...
save(imp_vars_fluid, file="/Users/Kat/Dropbox/HSPH_T32/Potential projects/ABCD melatonin/results/mel_use_SHAP_imputed_UPDATE_jan16.Rda")
...
inc <- inc %>%
  mutate_at(c("sds_p_ss_dims","famhx_ss_moth_prob_prf_p",    
              "reshist_addr1_p1vlnt",        
              "reshist_addr1_seg_ice_inc_bw", "cbcl_scr_syn_thought_r",      
              "asr_scr_somatic_t", "crpbi_y_ss_caregiver",        
              "hhinc_mid", "reshist_addr1_coi_r_he_nat" ), ~(scale(.) %>% as.vector)) 

glm_cvxgboost = glm(data=inc, mel_use ~ sds_p_ss_dims+famhx_ss_moth_prob_prf_p+    
                    as.factor(race_ethnicity)+reshist_addr1_p1vlnt+     
                    reshist_addr1_seg_ice_inc_bw+cbcl_scr_syn_thought_r+      
                    asr_scr_somatic_t+crpbi_y_ss_caregiver+       
                    hhinc_mid+reshist_addr1_coi_r_he_nat, family="binomial")
...
save(mel_or_label_shap,file="/Users/Kat/Dropbox/HSPH_T32/Potential projects/ABCD melatonin/results/mel_use_coef_imputed_update_Jan16.Rda")
write.csv(mel_or_label_shap, file="/Users/Kat/Dropbox/HSPH_T32/Potential projects/ABCD melatonin/results/mel_use_coef_imputed_update_Jan16.csv")
...
names(imp_vars_fluid) <- c("Short_Label","Variable","inc_mel_SHAP")
save(imp_vars_fluid, file="/Users/Kat/Dropbox/HSPH_T32/Potential projects/ABCD melatonin/results/mel_incident_use_SHAP_imputed_update_Jan16.Rda")
...
inc <- inc %>%
  mutate_at(c("sds_p_ss_dims","reshist_addr1_p1vlnt","asr_scr_somatic_t",
              "reshist_addr1_coi_r_he_nat","reshist_addr1_coi_r_he_nat",
              "screentime2_p_hours","bmi"), ~(scale(.) %>% as.vector)) 

glm_cvxgboost = glm(data=inc, mel_use ~ sds_p_ss_dims+reshist_addr1_p1vlnt+famhx_ss_moth_prob_prf_p+as.factor(race_ethnicity) +             
                    reshist_addr1_seg_ice_inc_bw+asr_scr_somatic_t+reshist_addr1_coi_r_he_nat+screentime2_p_hours+pubertal_sex_p+
                    bmi, family="binomial")
...
save(mel_or_label,file="/Users/Kat/Dropbox/HSPH_T32/Potential projects/ABCD melatonin/results/incident_mel_use_coef_imputed_update_Jan16.Rda")
write.csv(mel_or_label, file="/Users/Kat/Dropbox/HSPH_T32/Potential projects/ABCD melatonin/results/incident_mel_use_coef_imputed_update_Jan16.csv")
